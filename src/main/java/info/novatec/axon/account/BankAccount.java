...
public class BankAccount implements Serializable {
	...
	protected void on(AccountCreatedEvent event) {
		System.out.println("AccountCreatedEvent executed");
		this.id = event.id;
	...
	protected void on(DepositMoneyCommand command) {
		System.out.println("DepositMoneyCommand Executed");
	...
	protected void on(MoneyDepositedEvent event) {
		System.out.println("MoneyDepositedEvent Executed");
		this.balance += event.amount;
	}

	@CommandHandler
	protected void on(WithdrawMoneyCommand command) {
		System.out.println("WithdrawMoneyCommand executed");
	...
	protected void on(MoneyWithdrawnEvent event) {
		System.out.println("MoneyWithdrawnEvent executed");
		this.balance -= event.amount;
	}
